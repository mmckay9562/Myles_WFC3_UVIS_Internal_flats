...
base_path = '/grp/hst/wfc3v/mmckay/internal_flats/clean_tung3_raw_files/tung3_raw'
os.chdir(base_path)

F645N=os.path.join(base_path, 'tung3_F645N')
F656N=os.path.join(base_path, 'tung3_F656N')
F657N=os.path.join(base_path, 'tung3_F657N')
F658N=os.path.join(base_path, 'tung3_F658N')
F200LP=os.path.join(base_path,'tung3_F200LP')
F350LP=os.path.join(base_path,'tung3_F350LP')
F390W=os.path.join(base_path, 'tung3_F390W')
F410M=os.path.join(base_path, 'tung3_F410M')
F438W=os.path.join(base_path, 'tung3_F438W')
F467M=os.path.join(base_path, 'tung3_F467M')
F469N=os.path.join(base_path, 'tung3_F469N')
F475W=os.path.join(base_path, 'tung3_F475W')
F475X=os.path.join(base_path, 'tung3_F475X')
F487N=os.path.join(base_path, 'tung3_F487N')
F502N=os.path.join(base_path, 'tung3_F502N')
F547M=os.path.join(base_path, 'tung3_F547M')
F555W=os.path.join(base_path, 'tung3_F555W')
F600LP=os.path.join(base_path,'tung3_F600LP')
F606W=os.path.join(base_path, 'tung3_F606W')
F621M=os.path.join(base_path, 'tung3_F621M')
F625W=os.path.join(base_path, 'tung3_F625W')
F631N=os.path.join(base_path, 'tung3_F631N')
F665N=os.path.join(base_path, 'tung3_F665N')
F673N=os.path.join(base_path, 'tung3_F673N')
F680N=os.path.join(base_path, 'tung3_F680N')
F689M=os.path.join(base_path, 'tung3_F689M')
F763M=os.path.join(base_path, 'tung3_F763M')
F775W=os.path.join(base_path, 'tung3_F775W')
F814W=os.path.join(base_path, 'tung3_F814W')
F845M=os.path.join(base_path, 'tung3_F845M')
F850LP=os.path.join(base_path,'tung3_F850LP')
F953N=os.path.join(base_path, 'tung3_F953N')
FQ508N=os.path.join(base_path,'tung3_FQ508N')
FQ619N=os.path.join(base_path,'tung3_FQ619N')
FQ889N=os.path.join(base_path,'tung3_FQ889N')
F343N =os.path.join(base_path,'tung3_F343N')
F275W =os.path.join(base_path,'tung3_F275W')
FQ387N=os.path.join(base_path,'tung3_FQ387N')
F225W=os.path.join(base_path, 'tung3_F225W')
F395N=os.path.join(base_path, 'tung3_F395N')
FQ437N=os.path.join(base_path,'tung3_FQ437N')
F373N=os.path.join(base_path, 'tung3_F373N')
F336W=os.path.join(base_path, 'tung3_F336W')
F300X=os.path.join(base_path, 'tung3_F300X')
F390M=os.path.join(base_path, 'tung3_F390M')
F218W=os.path.join(base_path, 'tung3_F218W')
F280N=os.path.join(base_path, 'tung3_F280N')  

for file in glob.glob('*.fits'):
    value = fits.getheader(file)['filter']
    print(value)
    os.system('mkdir tung3_{}'.format(value))
